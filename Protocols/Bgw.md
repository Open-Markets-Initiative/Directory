## Bgw: IceFutures Derivatives Trading Platform Sbe Order Entry
...
Ice Binary Order Gateway (BGW) is the Sbe-encoded order entry protocol for the Ice Derivatives Trading Platform, succeeding Fix Order Server (FIX OS) for low-latency order management across futures, options, and strategy markets.
