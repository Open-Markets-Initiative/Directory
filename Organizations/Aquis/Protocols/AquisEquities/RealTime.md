## AquisEquities Real Time: Aquis Exchange real time market data

Binary real time market data feed of the Aquis Market Data (Amd) protocol, distributing order add, cancel, modify, trade, and auction events for securities traded on Aquis Exchange via Ip multicast.
