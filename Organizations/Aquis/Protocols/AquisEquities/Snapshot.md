## AquisEquities Snapshot: Aquis Exchange snapshot market data

Periodic snapshot feed of the Aquis Market Data (Amd) protocol publishing full order book state for securities traded on Aquis Exchange via Ip multicast, letting subscribers join mid-session.
