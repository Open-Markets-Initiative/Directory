## AquisEquities Replay: Aquis Exchange market data replay

Tcp replay service of the Aquis Market Data (Amd) protocol, providing login-authenticated recovery of missed messages from the real time multicast feed.
