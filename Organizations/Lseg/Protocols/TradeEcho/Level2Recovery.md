## TradeEcho Level2Recovery: Level 2 Recovery

Recovery service publishing Trade Echo reference data, instrument status and Level 2 quote book snapshots over a Tcp session using Group Ticker Plant framing.
