## AsxDerivatives Ntp: Asx Ntp Itch Market Data

High-speed binary market data protocol publishing real-time reference and trading data for futures and options traded on the Asx 24 derivatives market via the Asx New Trading Platform via Ip multicast.
