## Cboe Edga Equities Auction Feed

Pitch feed providing auction indicative and result data for Cboe Edga Equities Exchange.

### Overview

Equities Auction Feed delivers real-time opening, closing, and intraday auction information for instruments on Cboe Edga Equities Exchange. The feed includes indicative prices, paired and imbalance quantities, and auction result messages throughout the auction process.
