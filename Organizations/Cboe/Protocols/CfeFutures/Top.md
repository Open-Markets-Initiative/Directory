## CfeFutures Top: Cboe Futures Best Bid And Offer Data

Real-time top of book feed publishing best bid and offer quotations and last sale trades for futures traded on Cboe Futures Exchange (CFE).

### Overview

Top is the top of book market data feed for Cboe Futures Exchange (CFE), publishing best bid and best offer updates along with last sale trade reports for every listed futures instrument. It is a lightweight alternative to the full depth of book Pitch feed, designed for subscribers that only need current quotations.
...
- **Top of book** - Best bid and best offer for every Cboe Futures Exchange (CFE) instrument
