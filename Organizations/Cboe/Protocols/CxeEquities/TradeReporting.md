## CxeEquities Trade Reporting: Cboe CXE Fix trade reporting

Financial Information eXchange (Fix) trade reporting facility (Trf) protocol for Cboe CXE, used by Systematic Internalisers to maintain quotes (Quote, Quote Cancel, Quote Status Report) and to report off-book trades (Trade Capture Report) with acknowledgements.

### Overview

The Cboe CXE Trf is a Fix port combining Systematic Internaliser quote maintenance and off-book trade reporting.
