## BzxOptions Complex Top: Cboe BZX Options Complex Strategy Top Of Book

Top of book feed for complex multi-leg options strategies traded on Cboe BZX Options Exchange.

### Overview

Complex Top is the top of book market data feed for the complex order book on Cboe BZX Options Exchange, publishing best bid and offer quotations for multi-leg options strategies including spreads, straddles, and combinations. The feed also carries trade reports for executed complex orders and strategy definition messages.
