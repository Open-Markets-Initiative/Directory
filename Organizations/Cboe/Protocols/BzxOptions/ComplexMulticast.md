## BzxOptions Complex Multicast: Cboe BZX Options Complex Strategy Multicast Market Data

Udp multicast feed publishing complex strategy market data for Cboe BZX Options Exchange.

### Overview

Complex Multicast is the primary multicast market data feed for the complex order book on Cboe BZX Options Exchange. It bundles the top of book and depth of book events for complex strategies into a single multicast stream, simplifying subscriber integration while still providing full visibility into the complex book.
