## BzxOptions Complex Auction: Cboe BZX Options Complex Order Auction Event Data

Auction event feed publishing complex order auction information for multi-leg options strategies on Cboe BZX Options Exchange.

### Overview

Complex Auction is the auction event feed for the complex order book on Cboe BZX Options Exchange, publishing opening, closing, and intraday auction messages for multi-leg options strategies. It carries indicative prices, imbalance quantities, and auction status for every complex strategy auction.
