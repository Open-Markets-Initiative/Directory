...
| Protocol | Type | Note |
| --- | --- | --- |
| [AuctionFeed](AuctionFeed.md) | MarketData | Cboe BZX Options Auction Event Data |
| [ComplexAuction](ComplexAuction.md) | MarketData | Cboe BZX Options Complex Order Auction Event Data |
| [ComplexDepthOfBook](ComplexDepthOfBook.md) | MarketData | Cboe BZX Options Complex Strategy Full Depth Of Book |
