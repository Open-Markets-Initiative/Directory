## Cboe Bzx Options Complex Options

Pitch feed providing market data for complex options instruments including strategy definitions and order activity on Cboe Bzx Options Exchange.

### Overview

Options Complex Options delivers real-time market data for complex options instruments traded on Cboe Bzx Options Exchange. The feed provides strategy creation notifications, order activity, and execution data for user-defined and exchange-defined multi-leg combinations.
