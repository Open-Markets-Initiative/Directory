## BzxEquities Last Sale: Cboe BZX Trade Report Feed

Trade report feed publishing executed trade messages for equities traded on Cboe US Equities BZX Exchange.

### Overview

Last Sale is the trade report market data feed for Cboe US Equities BZX Exchange, publishing executed trade messages with price, size, and condition codes as trades occur. It provides a clean last-sale stream for subscribers that need trade information without the overhead of a full depth of book feed.
...
- **Last sale** - Executed trade stream for Cboe US Equities BZX Exchange
