## Cboe Edgx Options Flex

Pitch feed providing market data for flexible options instruments traded on Cboe Edgx Options Exchange.

### Overview

Options Flex delivers real-time market data for flexible options contracts on Cboe Edgx Options Exchange. Flex options allow customized strike prices, expiration dates, exercise styles, and settlement terms beyond the standard listed options series, and this feed provides order and execution data for those instruments.
