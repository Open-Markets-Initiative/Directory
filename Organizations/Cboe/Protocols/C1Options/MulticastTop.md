## Cboe Options Multicast Top Of Book

Pitch multicast feed providing best bid and offer updates for individual options series on Cboe Options Exchange.

### Overview

Options Multicast Top Of Book delivers lightweight real-time best bid and offer data for options series traded on Cboe Options Exchange. The feed provides Bbo quote updates without the overhead of full order-level depth, making it efficient for consumers requiring only top-of-book visibility.
