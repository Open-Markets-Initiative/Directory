## C1Options Multicast Top: Cboe Options Multicast Best Bid And Offer Data

Udp multicast top of book feed publishing best bid and offer quotations for options traded on Cboe Options Exchange (C1).

### Overview

Multicast Top is the Udp multicast variant of the Cboe Options Top feed, delivering best bid and offer quotation updates for options over Ip multicast with A and B feed redundancy. It is the preferred transport for latency-sensitive subscribers that want direct multicast delivery rather than Tcp unicast.
...
- **Top of book** - Best bid and best offer for every Cboe Options Exchange (C1) instrument
