## Cboe Options Complex Depth Of Book

Pitch multicast feed providing order-level depth of book for complex multi-leg options strategies on Cboe Options Exchange.

### Overview

Options Complex Depth Of Book delivers real-time order-by-order market data for complex options strategies traded on Cboe Options Exchange. The feed shows individual order activity for user-defined and exchange-defined multi-leg strategy combinations, enabling full book reconstruction for complex instruments.
