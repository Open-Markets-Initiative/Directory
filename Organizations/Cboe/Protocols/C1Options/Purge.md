## C1Options Purge: Cboe C1 Options Fix purge

Financial Information eXchange (Fix) purge port protocol for Cboe C1 Options, providing mass-cancel of resting orders and, where supported, cross-port order amend, with purge and amend acknowledgement and reject responses.

### Overview

The Purge port is a dedicated Fix session that lets a member mass-cancel resting orders on Cboe C1 Options (Purge Request) and receive Purge Acknowledgement and Purge Reject responses.
