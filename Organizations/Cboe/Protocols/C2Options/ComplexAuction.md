## Cboe C2 Options Complex Auction

Pitch feed providing auction indicative and result data for complex multi-leg options strategies on Cboe C2 Options Exchange.

### Overview

Options Complex Auction delivers real-time auction information for complex options strategies during auction periods on Cboe C2 Options Exchange. The feed provides indicative prices, paired and imbalance quantities, and auction results for multi-leg complex instruments.
