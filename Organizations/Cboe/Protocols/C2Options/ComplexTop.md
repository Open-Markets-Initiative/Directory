## Cboe C2 Options Complex Top Of Book

Pitch feed providing best bid and offer updates for complex multi-leg options strategies on Cboe C2 Options Exchange.

### Overview

Options Complex Top Of Book delivers lightweight real-time best bid and offer data for complex options strategies traded on Cboe C2 Options Exchange. The feed provides top-of-book quotes for multi-leg instruments without the overhead of full complex depth.
