## Cboe C2 Options Order Entry

Boe binary order entry protocol for submitting and managing orders on Cboe C2 Options Exchange.

### Overview

Options Order Entry provides low-latency order management for trading on Cboe C2 Options Exchange using the Boe binary protocol. The protocol supports new order submission, modification, cancellation, and execution reporting for individual series and complex multi-leg strategies.
