## PhlxOptions Order Feed: Nasdaq Phlx Options Order Level Market Data

Order-level market data feed publishing order add, modify, cancel, and execute events for Phlx Options.
...
- **Order level** - Individual order events for Phlx Options
