## PhlxOptions Depth Of Market: Nasdaq Phlx Options Depth Of Book Data

Full depth of book market data feed publishing order events for Phlx Options.
...
- **Full depth of book** - Order-by-order events for Phlx Options
