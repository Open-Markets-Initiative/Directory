## NordicEquities Total View Pure Stream: Nasdaq Nordic Full Depth Of Book Feed, PureStream Variant

Full depth of book market data feed for the Nasdaq Nordic equities markets running on the Inet Nordic platform, carrying the PureStream order book indicator.
...
- **PureStream** - Adds the PureStream venue Mic to the order book directory
