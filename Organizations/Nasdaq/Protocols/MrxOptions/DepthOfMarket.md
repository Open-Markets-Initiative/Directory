## MrxOptions Depth Of Market: Nasdaq Mrx Options Depth Of Book Data

Full depth of book market data feed publishing order events for Mrx Options.
...
- **Full depth of book** - Order-by-order events for Mrx Options
