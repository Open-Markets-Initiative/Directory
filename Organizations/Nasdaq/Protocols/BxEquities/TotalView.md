## BxEquities Total View: Nasdaq BX Full Depth Of Book Market Data

Full depth of book Itch-based market data feed publishing order-by-order events for equities traded on Nasdaq BX Equities.

### Overview

TotalView is the full depth of book market data feed for Nasdaq BX Equities, publishing order-by-order events using the Nasdaq Itch binary protocol. The feed delivers order add, modify, execute, and delete messages enabling subscribers to reconstruct the complete limit order book for every listed equity instrument.
