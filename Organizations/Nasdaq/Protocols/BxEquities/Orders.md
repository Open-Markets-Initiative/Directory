...
Ouch binary order entry protocol for submitting and managing equity orders on the Nasdaq Bx exchange.

### Overview

Orders provides the Ouch order entry interface to the Nasdaq Bx matching engine. The protocol supports the complete order lifecycle including new order submission, replacement, cancellation, and execution reporting with immediate acknowledgment.
