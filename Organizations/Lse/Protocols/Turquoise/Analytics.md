## Turquoise Analytics: Lse Turquoise Analytics Market Data

Analytics feed publishing derived analytics and statistics for securities traded on the Lse Turquoise Mtf.

### Overview

Turquoise Analytics is a market data feed for the London Stock Exchange Turquoise Multilateral Trading Facility (Mtf), delivered via the Lseg Group Ticker Plant (Gtp) binary format. The feed is distributed over Ip multicast with Tcp recovery services for gap fill.
