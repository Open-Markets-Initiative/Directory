## Securities B: Koscom Market Data Service Realtime Securities B product feed

Koscom-to-subscriber realtime market data output feed for the Securities B subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Securities B product feed** - MDCS Realtime Securities B subscription product of the Koscom market data output feed
