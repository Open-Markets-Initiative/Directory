## Reference Info Investor Activities: Koscom Market Data Service Realtime Reference Info and Investor Activities product feed

Koscom-to-subscriber realtime market data output feed for the Reference Info and Investor Activities subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Reference Info and Investor Activities product feed** - MDCS Realtime Reference Info and Investor Activities subscription product of the Koscom market data output feed
