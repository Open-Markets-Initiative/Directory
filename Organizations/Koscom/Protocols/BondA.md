## Bond A: Koscom Market Data Service Realtime Bond A product feed

Koscom-to-subscriber realtime market data output feed for the Bond A subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Bond A product feed** - MDCS Realtime Bond A subscription product of the Koscom market data output feed
