## Index Product1: Koscom Market Data Service Realtime Index Product 1 product feed

Koscom-to-subscriber realtime market data output feed for the Index Product 1 subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Index Product 1 product feed** - MDCS Realtime Index Product 1 subscription product of the Koscom market data output feed
