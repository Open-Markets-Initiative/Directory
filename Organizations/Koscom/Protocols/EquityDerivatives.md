## Equity Derivatives: Koscom Market Data Service Realtime Equity Derivatives product feed

Koscom-to-subscriber realtime market data output feed for the Equity Derivatives subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Equity Derivatives product feed** - MDCS Realtime Equity Derivatives subscription product of the Koscom market data output feed
