## Koscom: Koscom Market Data Service Realtime Koscom product feed

Koscom-to-subscriber realtime market data output feed for the Koscom subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Koscom product feed** - MDCS Realtime Koscom subscription product of the Koscom market data output feed
