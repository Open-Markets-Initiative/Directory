## Securities A: Koscom Market Data Service Realtime Securities A product feed

Koscom-to-subscriber realtime market data output feed for the Securities A subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Securities A product feed** - MDCS Realtime Securities A subscription product of the Koscom market data output feed
