## Commodities: Koscom Market Data Service Realtime Commodities product feed

Koscom-to-subscriber realtime market data output feed for the Commodities subscription product of the Market Data Service (MDCS), publishing KRX market activity as Exture ASCII fixed-width records over UDP multicast with two-level TR-CODE dispatch.
...
- **Commodities product feed** - MDCS Realtime Commodities subscription product of the Koscom market data output feed
