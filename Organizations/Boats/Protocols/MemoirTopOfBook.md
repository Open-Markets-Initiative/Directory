## Memoir Top Of Book: Boats Best Bid And Offer Data

Sbe-encoded market data protocol providing top of book best bid and offer information for securities traded on Blue Ocean Ats.

### Overview

Memoir Top Of Book is the best bid and offer market data protocol for Blue Ocean Ats (Boats), delivering real-time Bbo updates for all listed instruments during overnight trading sessions. Built on the Memx technology platform, the protocol uses Simple Binary Encoding (Sbe) for efficient binary message encoding.
